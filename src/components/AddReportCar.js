...
const AddMissingCarForm = (props) => {
    ...
    const submitIt = () => {
        const obj = {
            licensePlateNumber: licenseRef.current.value.toLowerCase(),
            ownerName: ownerRef.current.value,
            location: locationRef.current.value,
            date: dateRef.current.value,
            typeOfVehicle: typeRef.current.value,
        }
    ...
    return  (
        <Fragment>
            <form onSubmit={submitIt} className={styles['form']}>
                ...
                <div className={styles['form-input']}>
                    <label className={styles['form-label']}>Owner Name</label>
                    <Input
                        className={styles['form-input']}
                        type="text"
                ...
                <div className={styles['form-input']}>
                    <label className={styles['form-label']}>Type of Vehicle</label>
                    <Input
                        className={styles['form-input']}
                        type="text"
